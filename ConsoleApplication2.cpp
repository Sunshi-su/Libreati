...
private:
    ...
    void loadBooksData() {
        ...
        if (!file.is_open()) {
            ...
            books.push_back(Book(1, "Война и мир", "Л.Н. Толстой", "Роман", 1869,
                "Роман «Война и мир», одно из величайших произведений русской и мировой литературы, создавался Л.Н. Толстым на протяжении шести лет, восемь раз переписывался, а отдельные эпизоды — более двадцати раз.\n"
                "Исследователи насчитывают пятнадцать вариантов одного только начала романа. В данной книге использована вторая редакция «Войны и мира» (1873 год), наиболее полная и удобная для чтения, поскольку Толстой\n"
                "перевел на русский язык весь французский текст романа. Книга снабжена большим количеством иллюстраций, показывающих прототипов главных героев, исторических персонажей, а также хронику нашествия Наполеона на Россию.\n"
                "В книге приводятся развернутые комментарии к иллюстрациям. Из этих комментариев можно узнать много интересных и неожиданных подробностей об исторической канве романа «Война и мир»."));

            books.push_back(Book(2, "Преступление и наказание", "Ф.М. Достоевский", "Роман", 1866,
                "'Творчество Достоевского занимает важное место в истории русской и мировой литературы и философии. Глубокое сочувствие человеческому страданию, интерес и внимание ко всем униженным,\n"
                "отвергнутым париям общества - талантливому человеку, роковым образом 'заблудившемуся' в своем собственном сознании, преступнику, душевнобольному, падшей женщине, ребенку - сделали Достоевского одним\n"
                "из величайших писателей - гуманистов мира'. - Р.М.Фридлендер, доктор филологических наук."));

            books.push_back(Book(3, "Мастер и Маргарита", "М.А. Булгаков", "Фэнтези", 1967,
                "В Москву прибывает дьявол со своей свитой - так начинается череда невероятных происшествий. В это время талантливый мастер томится в доме скорби, а его возлюбленная Маргарита пытается его спасти.\n"
                "Творчество или ремесло, благополучие или страсть, справедливость или карьера, свет или тьма… Каждый из героев делает собственный выбор, который становится вкладом в вечную борьбу добра и зла."));

            books.push_back(Book(4, "Герой нашего времени", "М.Ю. Лермонтов", "Роман", 1949,
                "В основе повествования - история жизни главного героя, Григория Печорина. Произведение состоит из пяти частей, расположенных не в хронологическом порядке, \nоднако в этом есть своя логика."
                "Писатель постепенно начинает погружать читателя во внутренний мир его героя, циника, прожигателя жизни, ни во что не верящего, противоречивого и неоднозначного.\n"
            ...
            books.push_back(Book(6, "Отцы и дети", "И.С. Тургенев", "Роман", 1860,
                "Главный герой романа 'Отцы и дети' - молодой начинающий доктор Евгений Базаров. Воинствующий демократ и нигилист, представитель молодого поколения, он не признает авторитеты и отрицает привычные человеческие ценности,\n"
                "которые дороги 'отцам'. Это бесконечно живой образ, драматизм которого - во внутренних противоречиях и осознании якобы собственной незначительности. Пылкий бунтарь, он отчаянно хочет любить и быть любимым,\n"
                "но бежит от этого чувства, считая его пережитком прошлого."));

            books.push_back(Book(7, "Шерлок Холмс", "Дойл Артур Конан", "Детектив", 1892,
                "Более 100 лет мир читает произведения о Шерлоке Холмсе. Слава этого героя затмила всех знаменитых персонажей мировой литературы. Шерлок Холмс - наблюдательный, проницательный и находчивый человек.\n"
                "Его острый глаз замечает в окружающем мельчайшие детали, а тонкий ум легко и изобретательно связывает их воедино, приходя к неожиданным порою, но всегда правильным выводам.Шерлок Холмс - сыщик, расследование\n"
                "преступлений он стремится превратить в точную науку. Он хорошо знает людей, и это помогает ему распутывать самые запутанные преступления.Второй герой произведений Конан Дойла, посвященных Шерлоку Холмсу, -доктор Уотсон,\n"
                "неизменный спутник, а часто и помощник Шерлока Холмса. От его имени ведется повествование о тех сложных и загадочных преступлениях, выяснять причины и разыскивать виновников которых приходится Шерлоку Холмсу.\n"
                "Настоящий том включает первый сборник рассказов о знаменитом сыщике 'Приключения Шерлока Холмса' (1891 - 1892), среди которых 'Пестрая лента', 'Скандал в Богемии', 'Союз рыжих', 'Человек с рассеченной губой'\n"
                "и другие увлекательные и не менее известные произведения. В настоящем издании воспроизводятся все 104 иллюстрации известного британского художника Сидни Пэйджета, выполненные им для журнала 'Стрэнд.'"));
